...
public class AnimalDaoImpl implements AnimalDao
{
    ...
    {
        ListIterator<Animal> animalIterator = animalList.getAnimals()
                                                        .listIterator();
    ...
    public synchronized List<Animal> retrieve(Animal animalTemplate)
    {
        ...
        for (Animal animal : animalList.getAnimals())
        {
            ...
            {
                if (animal.getAddress() == null || !animal.getAddress()
                                                          .equals(animalTemplate.getAddress()))
                {
                    match = false;
                }
            }
            ...
            {
                if (animal.getAnimalType() == null || !animal.getAnimalType()
                                                             .equals(animalTemplate.getAnimalType()))
                {
                    match = false;
                }
            }

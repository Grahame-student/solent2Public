...
public class RestClientJerseyImplTest
{
    ...
    public void restClientRetreiveTest()
    {
        ...
        assertTrue(replyMessage.getBookList()
                               .getBooks()
                               .isEmpty());
        ...
        assertEquals(1, replyMessage2.getBookList()
                                     .getBooks()
                                     .size());

        Book book = replyMessage2.getBookList()
                                 .getBooks()
                                 .get(0);
    ...
    public void restClientRetreiveTemplateTest()
    {
        ...
        List<Book> bookList = replyMessage.getBookList()
                                          .getBooks();

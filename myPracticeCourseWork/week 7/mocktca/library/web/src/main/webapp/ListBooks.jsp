    ...
    <body>
        ...
        <table>
            ...
            <tr>
                ...
                <td><%=((book.getTitle() == null) ? "" : book.getTitle()) %>
                </td>
                <td><%=((book.getAuthor() == null) ? "" : book.getAuthor()) %>
                </td>
                <td><%=((book.getIsbn() == null) ? "" : book.getIsbn()) %>
                </td>
                <td>
        ...
        <p>Enter search criteria to find particular book. Search AND's fields. Empty fields are not included in
            search.</p>
        <form action="ListBooks.jsp">
            <table>
                <tr>
                    <td>title</td>
                    <td><input type="text" name="searchTitle" value="<%=( (searchTitle==null) ? "":searchTitle) %>">
                    </td>
                </tr>
                <tr>
                    <td>author</td>
                    <td><input type="text" name="searchAuthor" value="<%=( (searchAuthor==null) ? "":searchAuthor) %>">
                    </td>
                </tr>
                <tr>
                    <td>isbn</td>

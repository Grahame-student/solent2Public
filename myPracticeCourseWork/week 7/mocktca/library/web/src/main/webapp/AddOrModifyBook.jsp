        ...
        <form action="ListBooks.jsp">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="title" value="<%=((book.getTitle()==null) ? "":book.getTitle()) %>">
                    </td>
                </tr>
                <tr>
                    <td>author</td>
                    ...
                    <td><input type="text" name="author" value="<%=((book.getAuthor()==null) ? "":book.getAuthor()) %>">
                    </td>
                </tr>
                <tr>
                    <td>isbn</td>
